...
struct page_table pt_list_std[] = {
	...
	/* PCMCIA */
	{0x40000000, 0x40000000, 0x10000000, 0xc02},
};
...
struct page_table pt_list_eth[] = {
	...
	/*-------------------------------------------*/
	/* SDRAM */
	{0xc0000000, 0xc0000000, 0x04800000, 0xc0e},
	{0xc4800000, 0xc4800000, 0x00800000, 0xc02},
	{0xc5000000, 0xc5000000, 0x0b000000, 0xc0e},
	/* Flash */
	{0x60000000, 0x60000000, 0x10000000, 0xc02},
	/* Internal Register */
	{0x80000000, 0x80000000, 0x10000000, 0xc02},
...
int armadillo9_get_mmu_page_tables(struct platform_info *pinfo, u32 mode,
