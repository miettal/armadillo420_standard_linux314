...
#define imx_mxc_pwm_data_entry(soc, _devid, _id, _hwid, _size)		\
	[_id] = imx_mxc_pwm_data_entry_single(soc, _devid, _id, _hwid, _size)
...
#define imx25_mxc_pwm_data_entry(_id, _hwid)			\
	imx_mxc_pwm_data_entry(MX25, "imx27-pwm", _id, _hwid, SZ_16K)
